...
老师在 14 年的时候给他的 `is-online` 模块提交了一个很小的代码 -> 大神看了这个代码给老师抠了很多的细节（代码格式，写法、代码顺序之类的）

![抠细节](assets/img/2021-11-05-01-22-27.png)

> <https://github.com/sindresorhus/is-online/pull/28>

从中，老师认识到「一个开发人员对开发这个行业做到了极致或者做到一个特别一个完美的状态是什么样的」

大神要求说出你的初衷和目的之类的

从中老师意识到「自己平时所关注的东西是不是有价值的？」
